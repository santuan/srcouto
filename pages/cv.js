...
export default function CvPage() {
  ...
  return (
    <div className="px-2 pt-6 pb-6 2xl:pt-6 cvPage">
      <Link href="/">
      ...
      <div className="relative grid w-full max-w-4xl grid-cols-5 gap-2 px-2 mx-auto">
        <div className="relative col-span-2 w-96">
          <h1 className="relative z-10 flex flex-col font-mono text-4xl uppercase">
            <span className="font-black">santiago</span>
            <span className="font-normal">rodríguez</span>
            <span className="font-light">couto</span>
          </h1>
          <div className="absolute top-0 right-0 z-0 font-serif tracking-tighter text-white transform scale-150 -translate-x-20 translate-y-5 opacity-90 dark:text-gray-900 text-7xl">
            <span
        ...
        <div className="grid flex-1 w-full grid-cols-2 col-span-3 gap-3 2xl:h-28">
          <div className="flex flex-col my-2 space-y-3 text-base">
            <span>33 years</span>
            <span>buenos aires (argentina)</span>
          </div>
          <div className="flex flex-col my-2 space-y-3 text-base 2xl:text-right">
            <span>www.srcouto.ar</span>
            <span>santuan.bot@gmail.com</span>
          </div>
        </div>
      </div>
      <div className="grid w-full max-w-4xl min-h-screen grid-cols-5 gap-2 px-2 mx-auto text-xs">
        <div className="relative flex-initial col-span-2 pr-12 ">
          <div className="mt-3">
            <div className="border-b-2 border-gray-300 border-dotted">
              <h2 className="relative inline-block py-2 text-xl font-black uppercase border-b-2 border-gray-500 dark:border-white">
                knowledge
              </h2>
            </div>
              ...
              <div className="flex flex-col w-full">
                ...
                <div className="flex flex-wrap items-start justify-start w-full text-sm italic font-bold">
                  <span className="mt-2 mr-2 text-gray-700 border-b-2 border-gray-200 dark:text-gray-300 dark:border-gray-700">
                    #illustrator
                    <hr className="w-12 border-t-0 border-b-2 top-0.5 relative border-gray-600 dark:border-gray-300" />
                  </span>
                  <span className="mt-2 mr-2 text-gray-700 border-b-2 border-gray-200 dark:text-gray-300 dark:border-gray-700">
                    #photoshop
                    <hr className="w-12 border-t-0 border-b-2 top-0.5 relative border-gray-600 dark:border-gray-300" />
                  ...
                  <span className="mt-2 mr-2 text-gray-700 border-b-2 border-gray-200 dark:text-gray-300 dark:border-gray-700">
                    #inDesign
                    <hr className="w-6 border-t-0 border-b-2 top-0.5 relative border-gray-600 dark:border-gray-300" />
                  </span>
                  <span className="mt-2 mr-2 text-gray-700 border-b-2 border-gray-200 dark:text-gray-300 dark:border-gray-700">
                    #blender
                    <hr className="w-2 border-t-0 border-b-2 top-0.5 relative border-gray-600 dark:border-gray-300" />
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="flex mt-3">
              ...
              <div className="flex flex-col w-full">
                ...
                <div className="flex flex-wrap items-start justify-start w-full text-sm italic font-bold">
                  ...
                  <span className="mt-2 mr-2 text-gray-700 border-b-2 border-gray-200 dark:text-gray-300 dark:border-gray-700">
                    #tailwindCss
                    <hr className="w-8 border-t-0 border-b-2 top-0.5 relative border-gray-600 dark:border-gray-300" />
                  </span>
                  <span className="mt-2 mr-2 text-gray-700 border-b-2 border-gray-200 dark:text-gray-300 dark:border-gray-700">
                    #sass
                    <hr className="w-12 border-t-0 border-b-2 top-0.5 relative border-gray-600 dark:border-gray-300" />
        ...
        <div className="col-span-3 ">
          ...
          <div className="relative my-2">
            ...
            <time className="absolute top-0 right-0 flex flex-col items-end justify-end text-xs italic text-right opacity-50">
              Nov. 2018 ‒ present
          ...
          <div className="relative my-2">
            ...
            <h4 className="text-base uppercase">junior web designer</h4>
            <p>
          ...
          <div className="relative my-2">
            <h3 className="text-base font-black uppercase">
              tipitos argentinos{' '}
              <i className="text-xs normal-case opacity-50">by Aldo de Losa</i>
            </h3>
