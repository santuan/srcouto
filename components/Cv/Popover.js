...
const MobileControls = [
  {
    name: 'Zoom',
    description: 'Ampliar con dos dedos',
    href: '##',
    icon: IconOne
  },
  {
    name: 'Rotar',
    description: 'Arrastrar con un dedo',
    href: '##',
    icon: IconTwo
  }
];
...
export default function PopoverControls() {
  return (
    <div className="fixed z-50 items-center justify-end hidden w-full h-12 max-w-sm px-2 print:hidden md:flex top-0.5 right-16">
                ...
                <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                  <div className="relative hidden gap-5 p-4 bg-gray-100 dark:bg-gray-800 md:grid lg:grid-cols-1">
                    {DesktopControls.map((item) => (
                      ...
                      >
                        <div className="flex items-center justify-center flex-shrink-0 w-10 h-10 text-white bg-gray-300 rounded dark:bg-gray-700 print:bg-white sm:h-12 sm:w-12">
                  ...
                  <div className="relative grid gap-8 bg-gray-900 md:hidden p-7 lg:grid-cols-1">
                    {MobileControls.map((item) => (
                      <div
                        key={item.name}
                        href={item.href}
                        className="flex items-center p-2 -m-3 transition duration-150 ease-in-out rounded-lg hover:bg-gray-800 focus:outline-none focus-visible:ring focus-visible:ring-zinc-500 focus-visible:ring-opacity-50"
                      >
