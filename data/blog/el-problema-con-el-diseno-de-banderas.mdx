...
summary: 'Principios de diseños aplicados a símbolos.'
image: '/static/images/el-problema-con-el-diseno-de-banderas/las-banderas-de-la-ciudad.jpg'
---
...
_Se recomienda ver la experiencia completa en video._
...
<Image
  alt={`Bandera Chicago`}
  src={`/static/images/el-problema-con-el-diseno-de-banderas/bandera-chicago.png`}
...
<Image
  ...
  src={`/static/images/el-problema-con-el-diseno-de-banderas/bandera-san-francisco.png`}
  width={1070}
  height={717}
  priority
/>
...
<Image
  ...
  src={`/static/images/el-problema-con-el-diseno-de-banderas/redisenio-bandera-amsterdam.png`}
  className="aspect-w-9 aspect-h-12"
  layout="responsive"
  width={1807}
  height={835}
...
<Image
  ...
  src={`/static/images/el-problema-con-el-diseno-de-banderas/aplicacion-bandera-amsterdam.jpg`}
  className="aspect-w-9 aspect-h-12"
  layout="responsive"
  width={1913}
  height={969}
...
<p>
  <a
    ...
    class="font-bold external-link hover:text-blue-200"
    target="_blank"
...
<Image
  alt={`Aplicacion de la bandera de Amsterdam`}
  src={`/static/images/el-problema-con-el-diseno-de-banderas/Bandera_de_la_Ciudad_de_Buenos_Aires.jpg`}
  className="aspect-w-9 aspect-h-12"
  layout="responsive"
  width={1920}
  height={1080}
...
<Image
  alt={`Aplicacion de la bandera de Amsterdam`}
  src={`/static/images/el-problema-con-el-diseno-de-banderas/las-banderas-de-la-ciudad.jpg`}
  className="aspect-w-9 aspect-h-12"
  layout="responsive"
  width={1002}
  height={668}
