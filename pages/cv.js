...
export default function CvPage() {
  ...
  return (
    <div className="relative px-2 pt-12 pb-8 overflow-x-hidden font-sans print:text-gray-900 md:pt-20 print:pt-3 print:md:pt-3 cvPage">
      ...
      <div
        className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center w-full h-12 bg-white md:bg-transparent md:bottom-0 bg-opacity-90 dark:bg-gray-900 dark:bg-opacity-90 print:hidden md:backdrop-blur-0"
      >
        <Link href="/">
      ...
      <div className="grid w-full max-w-4xl min-h-screen grid-cols-1 mx-auto text-sm md:gap-2 print:max-w-full print:grid-cols-5 md:grid-cols-5 print:min-h-full print:text-xs">
              ...
              <div className="flex flex-col w-full">
                ...
                <div className="flex flex-wrap items-start justify-start w-full text-sm italic font-medium">
                  <span
                    ...
                    className="mt-2 mr-2 border-b-2 text-zinc-700 border-zinc-200 dark:text-zinc-300 dark:border-zinc-700 hover:opacity-70"
                  >
                    #illustrator
                  ...
                  <span
                    ...
                    className="mt-2 mr-2 font-medium border-b-2 text-zinc-700 border-zinc-200 dark:text-zinc-300 dark:border-zinc-700 hover:opacity-70"
                  >
                    #photoshop
                    <hr className="w-[80%] border-t-0 border-b-2 top-0.5 relative border-zinc-600 dark:border-zinc-300 print:border-zinc-300" />
                  </span>
        ...
        <div className="col-span-3 ">
          ...
          <div className="relative my-3 print:mt-2">
            ...
            <h4 className="text-sm italic font-medium opacity-70">
            ...
            <time className="relative left-0 flex items-start justify-end text-xs italic opacity-50 md:flex-col md:items-end md:text-right md:left-auto md:right-0 top-2 md:top-0 md:absolute print:text-xs print:absolute print:right-0 print:items-end print:top-2 print:z-0 print:flex-col">
              <span className="ml-2 uppercase md:ml-0">public sector</span>
              Nov. 2018 ‒ present
            </time>
          </div>
          ...
          <div className="relative my-3 print:mt-2">
            ...
            <time className="relative left-0 flex items-start justify-end text-xs italic opacity-50 md:flex-col md:items-end md:text-right md:left-auto md:right-0 top-2 md:top-0 md:absolute print:text-xs print:absolute print:right-0 print:items-end print:top-2 print:z-0 print:flex-col">
              <span className="ml-2 uppercase md:ml-0">private sector</span>
              Feb. 2013 ‒ Mar. 2014
            </time>
          </div>
          <hr className="my-2 border-dashed border-zinc-900 opacity-30" />
